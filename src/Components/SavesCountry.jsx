...
function SavesCountry({ info }) {
    ...
    ///
    return (
        <div onClick={isPopupOpen == true ? closePopup : forExample} className='flex flex-col border p-[20px] w-[400px] bg-red-600 rounded-xl text-white' >
